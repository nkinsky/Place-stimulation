...
%% convert linear position along track to value between 0 and 1 for output to 
% arduino PWM pin
function [dutycycle] = linpos2dutycycle(lin_pos)
track_length_use = 20; % should be a lot longer than actual.

dutycycle = double(lin_pos/track_length_use+0.5);

if dutycycle < 0; dutycycle = 0; elseif dutycycle > 1; dutycycle = 1; end
